...
struct HostData {
    Scalar m_isovalue;
    int m_numInVertData = 0, m_numInVertDataIdx = 0, m_numInVertDataB = 0;
    int m_numInCellData = 0, m_numInCellDataIdx = 0, m_numInCellDataB = 0;
    ...
    void addmappeddata(const Index *mapdata)
    {
        ...
        m_numInVertDataIdx = m_inVertPtrI.size();
    }
